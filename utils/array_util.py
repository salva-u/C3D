...
def interpolate(features, features_per_bag): #gives the number of instances in the bag needed
...
def extrapolate(outputs, num_frames): #adds temporal smoothness to iutput ?
